...
11. As a Dieter, I want to be notified on WhatsApp when my coach leaves
feedback, so that I don't have to keep checking for it.
...
design time.
- Coach feedback notifications are sent via WhatsApp — the user already
intends to use it for this, so it is named directly rather than left as a
capability.
- A Coach can be connected to more than one Dieter; a Dieter can be connected
to more than one Coach.
