...
/** Case-insensitive substring match against the role keyword, per security.json's role names. */
...
/** Resolves the caller's app role from their groups. Dieter wins if both match. */
